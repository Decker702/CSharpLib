...
namespace _0._04_Conditional_if//If statement identifies which statment to run based on the value of a Boolean expression.
{                               
    class Program
    {
        ...
        {  
            ...
            if (isOn || isHot)//Operator || is conditional for or; either have to be true for it to print.
